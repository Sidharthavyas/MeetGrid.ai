...
export const SignUpView =()=>{
    ...
    return(
                            ...
                            <div className="flex flex-col gap-6 ">
                                ...
                                <div className="grid gap-3">
                                    ...
                                    <div className="text-center text-sm">Already have an account?{" "}
                                        <Link href="/sign-in" className="underline font-bold underline-offset-4 ">
                                         Sign In
                                        </Link>
        ...
        <div className="text-muted-foreground *:[a]:hover:text-primary text-center text-xs text-balance *:[a]:underline  *:[a]:underline-offset-4">
            By Clicking Continue, you aree to our <a href="#">Terms of Service</a> and <a href="#">Privacy Policy</a>
        </div>
   </div>
    )
}